...
<html lang="en" class=" is-copy-enabled">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <link rel="web-socket" href="wss://live.github.com/_sockets/OTcxOTM3NzplYzkzNThmMzg5Nzk3Yjg2ODM0OTUxZjNlZDg0ODY5ZTpiN2M3ZTdiOWJiYzg3MDA0Zjk1MzA3ZmEyNGM2MjY0NDNjYWNhMzljZTRhZWQ1Y2I5ZDc0N2UwNWQ2YTVkYzgy--94480e7ef255577eb9ce9bf2c504b5b59f18ed32">
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="31C87F56:751F:114078C:5598EEAF" name="octolytics-dimension-request_id" /><meta content="9719377" name="octolytics-actor-id" /><meta content="Sarthak07" name="octolytics-actor-login" /><meta content="59a8364d9e936e1267fe0ea7b91fef560e776eb56454a912b06d383c18c70b95" name="octolytics-actor-hash" />
...
<meta content="jIv7x0fDePuh9eBzCotqk1uLafoVUO8AL34jTl33/ts9HiNzrJy3HSDVmRWOV+VYt/VdnM93MJAKftEkOEG3OA==" name="csrf-token" />
  ...
  <li class="header-nav-item dropdown js-menu-container">
    ...
    <div class="dropdown-menu-content js-menu-content">
      <div class="dropdown-menu dropdown-menu-sw">
        ...
        <form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="9bjsC/zE782eKIY41GLURQDsFvclS0PgB6mZJ7FxT5zWHh0u10jUykVRtBI2iPNNOu89ElzYgR2Hr2VUDT31fQ==" /></div>
...
<ul class="pagehead-actions">
  ...
  <li>
      <form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="N/ef+XCIcYF8tX0Gl7GPPzzElO19/A+xiYyouamgfv2XrpVrCprSmHJDpQEYnI4Ie7m+X/wBkGw9AqJWYEQUnA==" /></div>    <input id="repository_id" name="repository_id" type="hidden" value="22669134" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    ...
    <form accept-charset="UTF-8" action="/rfoxfa/Exploratory_Data_Analysis/unstar" class="js-toggler-form starred js-unstar-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="R9ex8Rcn8eYcvs3bEpL2akWYqe+oWUUE2Fc7k8ePDBAkRokgGWNCiM+DeioKS4B9UyBSh2okQd5XufylA3eXog==" /></div>
      <button
    ...
    <form accept-charset="UTF-8" action="/rfoxfa/Exploratory_Data_Analysis/star" class="js-toggler-form unstarred js-star-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="1a9ej6tgGNVcqqaUYWVZHZkpFdghhih6c5nRw58k96twBevkcQQzOLHH52N0TQM+Z2DrZRWA83VbvuPlhGdBvw==" /></div>
      <button
        class="btn btn-sm btn-with-count js-toggler-target"
        ...
        <li>
          <form accept-charset="UTF-8" action="/rfoxfa/Exploratory_Data_Analysis/fork" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="8Cu+P98yWvxDpS0lVvY6yie/GKIWZtUoBuWSzjKIC9STeYT58SJYcfje/mqFbB5nf+XcXq3kpbOq6sYrPyUvlg==" /></div>
            <button
                type="submit"
...
<div class="clone-options">You can clone with
  <form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=http&amp;protocol_type=clone" class="inline-form js-clone-selector-form is-enabled" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="Wc6FmWUBkxvqbc31hj6wdSiIpleRutxuXS6r5EaaAONRfywo8evx0O7OhcE2Pgxwu4Mc2HcR1yD6IPQZabUBrQ==" /></div><button class="btn-link js-clone-selector" data-protocol="http" type="submit">HTTPS</button></form>, <form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=ssh&amp;protocol_type=clone" class="inline-form js-clone-selector-form is-enabled" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="NqrF1XVoG7PdbZkDF9dAA/1by43axM53hbgFvDTWVOsCvCFrHn536kScH1n08yrAEVcshducgRF3+T0nF779Ew==" /></div><button class="btn-link js-clone-selector" data-protocol="ssh" type="submit">SSH</button></form>, or <form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=subversion&amp;protocol_type=clone" class="inline-form js-clone-selector-form is-enabled" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="wEtDiu6BbPx5RnQeIvwqWfv9z+SzMGvurKf5WWAs2F+6tNN5xyjUiOP7FE1KGlwwQZzcEuGugFDSr88w1XhAjg==" /></div><button class="btn-link js-clone-selector" data-protocol="subversion" type="submit">Subversion</button></form>.
...
<a href="/rfoxfa/Exploratory_Data_Analysis/blob/8e7bdea35aed208158bd2225540468ff3159fbff/Course%20Project%202/plot3.R" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:94c9d258e9d147c46d480311e2e2eb55 -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/rfoxfa/Exploratory_Data_Analysis/blob/master/Course%20Project%202/plot3.R"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
...
<include-fragment class="commit commit-loader file-history-tease" src="/rfoxfa/Exploratory_Data_Analysis/contributors/master/Course%20Project%202/plot3.R">
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/rfoxfa/Exploratory_Data_Analysis/raw/master/Course%20Project%202/plot3.R" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/rfoxfa/Exploratory_Data_Analysis/blame/master/Course%20Project%202/plot3.R" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/rfoxfa/Exploratory_Data_Analysis/commits/master/Course%20Project%202/plot3.R" class="btn btn-sm " rel="nofollow">History</a>
      </div>


            <form accept-charset="UTF-8" action="/rfoxfa/Exploratory_Data_Analysis/edit/master/Course%20Project%202/plot3.R" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="iqxgmhVERrRgBFZeSwuldFuvPNNFE9zuUopYwUem9et0hXYwSzAE/f31qoA4XDdZLOEez95rMKr+hAVOPONYqg==" /></div>
              <button class="octicon-btn tooltipped tooltipped-n" type="submit" aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
                <span class="octicon octicon-pencil"></span>
              </button>
</form>
          <form accept-charset="UTF-8" action="/rfoxfa/Exploratory_Data_Analysis/delete/master/Course%20Project%202/plot3.R" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="R7gy4P72NAnxd8FU2ikx1kheVx7VaIX666RIvvptqZNUprg8A2B+E1SvdTO6+cyx9PFToVJkekKg1Ii3eBWLZw==" /></div>
  ...
  <div class="blob-wrapper data type-r">
      ...
      <tr>
        ...
        <td id="LC7" class="blob-code blob-code-inner js-file-line"><span class="pl-c"># Samples data for testing</span></td>
      </tr>
      <tr>
        <td id="L8" class="blob-num js-line-number" data-line-number="8"></td>
        <td id="LC8" class="blob-code blob-code-inner js-file-line"><span class="pl-smi">NEIsample</span> <span class="pl-k">&lt;-</span> <span class="pl-smi">NEI</span>[sample(nrow(<span class="pl-smi">NEI</span>), <span class="pl-v">size</span> <span class="pl-k">=</span> <span class="pl-c1">5000</span>, <span class="pl-v">replace</span> <span class="pl-k">=</span> <span class="pl-c1">F</span>), ]</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC10" class="blob-code blob-code-inner js-file-line"><span class="pl-c"># Baltimore City, Maryland == fips</span></td>
      </tr>
      <tr>
        <td id="L11" class="blob-num js-line-number" data-line-number="11"></td>
        <td id="LC11" class="blob-code blob-code-inner js-file-line"><span class="pl-smi">MD</span> <span class="pl-k">&lt;-</span> subset(<span class="pl-smi">NEI</span>, <span class="pl-smi">fips</span> <span class="pl-k">==</span> <span class="pl-c1">24510</span>)</td>
      </tr>
      <tr>
        <td id="L12" class="blob-num js-line-number" data-line-number="12"></td>
        <td id="LC12" class="blob-code blob-code-inner js-file-line"><span class="pl-smi">MD</span><span class="pl-k">$</span><span class="pl-smi">year</span> <span class="pl-k">&lt;-</span> <span class="pl-k">factor</span>(<span class="pl-smi">MD</span><span class="pl-k">$</span><span class="pl-smi">year</span>, <span class="pl-v">levels</span> <span class="pl-k">=</span> c(<span class="pl-s"><span class="pl-pds">&#39;</span>1999<span class="pl-pds">&#39;</span></span>, <span class="pl-s"><span class="pl-pds">&#39;</span>2002<span class="pl-pds">&#39;</span></span>, <span class="pl-s"><span class="pl-pds">&#39;</span>2005<span class="pl-pds">&#39;</span></span>, <span class="pl-s"><span class="pl-pds">&#39;</span>2008<span class="pl-pds">&#39;</span></span>))</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC14" class="blob-code blob-code-inner js-file-line">png(<span class="pl-s"><span class="pl-pds">&#39;</span>plot3.png<span class="pl-pds">&#39;</span></span>, <span class="pl-v">width</span> <span class="pl-k">=</span> <span class="pl-c1">800</span>, <span class="pl-v">height</span> <span class="pl-k">=</span> <span class="pl-c1">500</span>, <span class="pl-v">units</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">&#39;</span>px<span class="pl-pds">&#39;</span></span>)</td>
      </tr>
      <tr>
        <td id="L15" class="blob-num js-line-number" data-line-number="15"></td>
        <td id="LC15" class="blob-code blob-code-inner js-file-line">ggplot(<span class="pl-v">data</span> <span class="pl-k">=</span> <span class="pl-smi">MD</span>, aes(<span class="pl-v">x</span> <span class="pl-k">=</span> <span class="pl-smi">year</span>, <span class="pl-v">y</span> <span class="pl-k">=</span> log(<span class="pl-smi">Emissions</span>))) <span class="pl-k">+</span> facet_grid(. <span class="pl-k">~</span> <span class="pl-smi">type</span>) <span class="pl-k">+</span> guides(<span class="pl-v">fill</span> <span class="pl-k">=</span> <span class="pl-c1">F</span>) <span class="pl-k">+</span> geom_boxplot(aes(<span class="pl-v">fill</span> <span class="pl-k">=</span> <span class="pl-smi">type</span>)) <span class="pl-k">+</span> stat_boxplot(<span class="pl-v">geom</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">&#39;</span>errorbar<span class="pl-pds">&#39;</span></span>) <span class="pl-k">+</span> ylab(expression(paste(<span class="pl-s"><span class="pl-pds">&#39;</span>Log<span class="pl-pds">&#39;</span></span>, <span class="pl-s"><span class="pl-pds">&#39;</span> of PM<span class="pl-pds">&#39;</span></span>[<span class="pl-c1">2.5</span>], <span class="pl-s"><span class="pl-pds">&#39;</span> Emissions<span class="pl-pds">&#39;</span></span>))) <span class="pl-k">+</span> xlab(<span class="pl-s"><span class="pl-pds">&#39;</span>Year<span class="pl-pds">&#39;</span></span>) <span class="pl-k">+</span> ggtitle(<span class="pl-s"><span class="pl-pds">&#39;</span>Emissions per Type in Baltimore City, Maryland<span class="pl-pds">&#39;</span></span>) <span class="pl-k">+</span> geom_jitter(<span class="pl-v">alpha</span> <span class="pl-k">=</span> <span class="pl-c1">0.10</span>)</td>
      </tr>
      <tr>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.07924s from github-fe119-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
